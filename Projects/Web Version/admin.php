...
<div id="modifyPopup" class="modal fade" role="dialog">
    <div class="modal-dialog">
        <div class="modal-content">
            <div class="modal-header">
                <button type="button" class="close" data-dismiss="modal">&times;</button>
            ...
            <div class="modal-body" id="modifyContainer">

            </div>
            <div class="modal-footer">
                <img id="loading4" name="loading2" src="loading.gif"  height="25" width="25" style="visibility: hidden" /><span id="modifyMessage">Message</span>
                <button type="button" class="btn btn-danger btn-lg" data-dismiss="modal">Close</button>
            </div>
        </div>
    </div>
